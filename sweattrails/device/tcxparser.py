...
def tcx_set_lap_time(context, seconds):
    ...
    context.activity["total_elapsed_time"] = context.activity["total_elapsed_time"] + seconds
    context.activity["total_timer_time"] = context.activity["total_timer_time"] + seconds
...
def tcx_set_longitude(context, lon):
    context.trackpoint["position_long"] = gripe.conversions.degrees_to_semicircles(float(lon))
