...
FIELD_TYPES = {
    ...
    'garmin_product': FieldType(
        ...
        values={
            ...
            6: 'dsi_alf02',
            7: 'hrm3ss',
            8: 'hrm_run_single_byte_product_id',  # hrm_run datamodel for HRM ANT+ messaging
            9: 'bsm',  # BSM datamodel for ANT+ messaging
            10: 'bcm',  # BCM datamodel for ANT+ messaging
            11: 'axs01',  # AXS01 HRM Bike Chipset datamodel for ANT+ messaging
            12: 'hrm_tri_single_byte_product_id',  # hrm_tri datamodel for HRM ANT+ messaging
            14: 'fr225_single_byte_product_id',  # fr225 datamodel for HRM ANT+ messaging
            473: 'fr301_china',
            474: 'fr301_japan',
            475: 'fr301_korea',
            494: 'fr301_taiwan',
...
MESSAGE_TYPES = {
    ...
    0: MessageType(  # Must be first message in file.
        ...
        fields={
            ...
            8: Field(  # Optional free form string to indicate the devices name or datamodel
                name='product_name',
    ...
    23: MessageType(
        ...
        fields={
            ...
            27: Field(  # Optional free form string to indicate the devices name or datamodel
                name='product_name',
                type=BASE_TYPES[0x07],  # string
                def_num=27,
            ),
